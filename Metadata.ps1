#Query the meta data of a VM within Azure and provide a json formatted output
...
#For VM Tags (Example for: particular data key to be retrieved individually)
...
#To get a unique ID for a VM (Example for: particular data key to be retrieved individually)
